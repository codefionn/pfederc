...
namespace feder {
  namespace lexer {
    ...
    public:
       ...
       * \see getColumnEnd
       */
      std::size_t getColumnStart() const noexcept
      { return columnStart; }

      /*!\return Returns last column of the marked area.
       * \see getColumnStart
       */
      std::size_t getColumnEnd() const noexcept
      { return columnEnd; }

      /*!\return Returns first line of the marked area.
       * \see getLineEnd
       */
      std::size_t getLineStart() const noexcept
      { return lineStart; }

      /*!\return Returns last line of the marked area.
       * \see getLineStart
       */
      std::size_t getLineEnd() const noexcept
      { return lineEnd; }
